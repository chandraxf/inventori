<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12">
                    <form action="<?= base_url('admin/Barang_masuk/simpan') ?>" method="POST" id="form-barang-masuk">
                        <?= csrf_field() ?>
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Jenis Masuk <span class="text-danger">*</span></label>
                                            <select name="jenis_masuk" class="form-control" required>
                                                <option value="pembelian">Pembelian</option>
                                                <option value="retur_dari_unit">Retur dari Unit</option>
                                                <option value="koreksi_plus">Koreksi Plus</option>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nomor_faktur" class="form-control" placeholder="Nomor Faktur/Nota">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
    ...
    $(document).ready(function() {
        ...
        function initializeSelect2(element) {
            ...
            element.select2({
                ...
                allowClear: true,
                ajax: {
                    url: '<?= base_url('admin/barang_masuk/search_barang') ?>',
                    dataType: 'json',
                    delay: 250,
        ...
        $(document).on('select2:select', '.barang-select', function(e) {
            ...
            if (data.id) {
                $.ajax({
                    url: '<?= base_url('admin/barang_masuk/get_barang_detail/') ?>' + data.id,
                    type: 'GET',
                    dataType: 'json',

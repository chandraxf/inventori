        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12 col-md-6 col-lg-6">
                    <div class="card">
                        <form action="<?= base_url('admin/master-unit/edit/'.$unit->id) ?>" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="kode_unit" class="form-control" 
                                           value="<?= set_value('kode_unit', $unit->kode_unit) ?>" required>
                                </div>
                                
                                <div class="form-group">
                                    <label>Nama Unit <span class="text-danger">*</span></label>
                                    <input type="text" name="nama_unit" class="form-control" 
                                           value="<?= set_value('nama_unit', $unit->nama_unit) ?>" required>
                                </div>
                                
                                <div class="form-group">
                                    <label>Penanggung Jawab</label>
                                    <input type="text" name="penanggung_jawab" class="form-control" 
                                           value="<?= set_value('penanggung_jawab', $unit->penanggung_jawab) ?>">
                                </div>
